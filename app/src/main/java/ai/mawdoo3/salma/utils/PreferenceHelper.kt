...
object PreferenceHelper {
    ...
    const val PREF_JWT_IV = "PREF_JWT_IV"
    const val PREF_JWT_TOKEN = "PREF_JWT_TOKEN"
    const val PREF_REFRESH_TOKEN = "PREF_REFRESH_TOKEN"
    const val PREF_ENABLE_BIOMETRIC_LOGIN = "PREF_ENABLE_BIOMETRIC_LOGIN"
    const val PREF_USER = "PREF_USER"
    const val PREF_USER_INTERFACE_MODE = "PREF_USER_INTERFACE_MODE"
